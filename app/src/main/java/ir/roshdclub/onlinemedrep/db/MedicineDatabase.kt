...
//                    wordDao.deleteAll()
                    ...
                    medicineDao.insertMedicines(word)
                    word = Medicine(12, "مقاله علمی (۱)", "مقالات علمی", "مقالات علمی", R.drawable.ic_copyright, "bmjopen.pdf")
                    medicineDao.insertMedicines(word)
                    word = Medicine(13, "مقاله علمی (۲)", "مقالات علمی", "مقالات علمی", R.drawable.ic_copyright, "naturopathy.pdf")
                    medicineDao.insertMedicines(word)
                    word = Medicine(14, "مقاله علمی (۳)", "مقالات علمی", "مقالات علمی", R.drawable.ic_copyright, "functionalboweldisorders.pdf")
                    medicineDao.insertMedicines(word)
                    word = Medicine(15, "مقاله علمی (۴)", "مقالات علمی", "مقالات علمی", R.drawable.ic_copyright, "shingles.pdf")
                    medicineDao.insertMedicines(word)
                    word = Medicine(16, "مقاله علمی (۵)", "مقالات علمی", "مقالات علمی", R.drawable.ic_copyright, "vitiligo.pdf")
                    medicineDao.insertMedicines(word)
                    ...
                    medicineDao.insertMedicines(word)
                    word = Medicine(26, "هپارین (Heparin)", "هپارین,heparin", "قلب و عروق", R.drawable.ic_heart, "heparin.pdf")
                    medicineDao.insertMedicines(word)
                    word = Medicine(27, "منیزیوم هیدروکسید (Magnesium hydroxide)", "منیزیوم هیدروکسید,magnesium hydroxide", "گوارش", R.drawable.ic_esophagus, "mgoh.pdf")
                    medicineDao.insertMedicines(word)
                    ...
                    medicineDao.insertMedicines(word)
                    word = Medicine(55, "همایش (۱)", "همایش,کنفرانس", "همایش ها", R.drawable.ic_lecture, "conbio.pdf")
                    medicineDao.insertMedicines(word)
                    word = Medicine(56, "همایش (۲)", "همایش,کنفرانس", "همایش ها", R.drawable.ic_lecture, "concare.pdf")
                    medicineDao.insertMedicines(word)
                    word = Medicine(57, "همایش (۳)", "همایش,کنفرانس", "همایش ها", R.drawable.ic_lecture, "conmedical.pdf")
                    medicineDao.insertMedicines(word)
                    word = Medicine(58, "همایش (۴)", "همایش,کنفرانس", "همایش ها", R.drawable.ic_lecture, "concan.pdf")
                    medicineDao.insertMedicines(word)
